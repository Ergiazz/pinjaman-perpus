<?php
include("crud.php");
$dapat = tampilkan("SELECT * FROM book");
$i = 1; 
?>
<!doctype html>
<html lang="en">
  ...
  <ul class="navbar-nav mr-auto">
    ...
    <li id="nyala"><a href="../book/book.php">book</a></li>
      <li><a href="../datauser/datauser.php">USER</a></li>
  </ul>
...
<table class="table table-dark">
  ...
  <thead>
    <h3>DATA BUKU:</h3>
    <a href="newbook.php"><button id="add" type="submit">ADD NEW</button></a>
    <tr>
      <th scope="col">NO</th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?= $dapa["jumlah"]?></td>
      <td>
      <a href="hapus.php?id=<?= $dapa["id_buku"];?>">DELETE</a> |
      <a href="edit.php?id=<?= $dapa["id_buku"];?>">EDIT</a>
    </td>
    </tr>
    <?php endforeach;?>
  </tbody>
