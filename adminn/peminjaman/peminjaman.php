...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li id="nyala"><a href="../peminjaman/peminjaman.php">PEMINJAMAN</a></li>
      <li><a href="../book/book.php">book</a></li>
      <li><a href="../datauser/datauser.php">USER</a>
      </li>
    </ul>
...
<table class="table table-dark">
  ...
  <thead>
    ...
    <a href="new.php"><button id="add" type="submit">ADD NEW</button></a>
    <tr>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
      <a href="hapus.php?id=<?= $dapa["id_peminjaman"];?>">DELETE</a> |
      <a href="edit.php?id=<?= $dapa["id_peminjaman"];?>">EDIT</a>
    </td>
    </tr>
    <?php endforeach;?>
  </tbody>
